...
@Entity @Table(name="lms_academy") public class Academy extends BaseEntity {
    ...
    protected Academy(){} public Academy(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
